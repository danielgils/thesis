...
use klchoice.betatrue1_nondiag; read all into truebeta;
/*
use klchoice.initialsets_KLP; read all into initialsets;
*/

use klchoice.mutrue1_nondiag; read all into pmean;
use klchoice.sigmatrue1_nondiag; read all into pcov;
